    ...
    >
      <div className='max-w-screen-lg mx-auto p-4 flex flex-col justify-center w-full h-full text-white text-start'>
        <div className='mt-10 pt-10 md:pt-0'>
          <p className='text-3xl md:text-4xl font-bold border-b-2 md:border-b-4 border-gray-500 p-1 pl-0 inline'>
            Experience
          </p>
        ...
        <div className='w-full grid grid-cols-2 sm:grid-cols-3 gap-8 text-center py-6 px-4'>
