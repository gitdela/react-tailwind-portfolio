...
const Home = () => {
  ...
  return (
    ...
    >
      <div className='max-w-screen-lg mx-auto flex flex-col-reverse items-center justify-center h-full px-4 py-20 md:pt-0 md:pb-0 md:h-screen md:flex-row'>
        <div className='flex flex-col pt-10 space-y-4 justify-center h-full w-full md:space-y-0 md:pt-0 md:w-1/2'>
          ...
          <p className='text-white py-4 text-md md:text-xl'>
            I'm a lifelong learner who loves building beautiful interfaces, web
            apps and everything in between. You can check out my portfolio
            below!
          </p>
          <div className='flex justify-center items-center lg:hidden'>
            <ul className='flex justify-start items-center mb-4 w-full'>
              {links.map(({ id, child, href, color }) => (
                <li
                  key={id}
                  className={`flex justify-between basis-8 items-center`}
                >
                  <a
                    href={href}
          ...
          <div>
            ...
            <Link
              ...
              smooth
              duration={500}
              className='group text-white w-fit px-6 py-3 my-8 flex items-center cursor-pointer rounded-md bg-gradient-to-r from-cyan-500 to-blue-500'
            >
              Explore
